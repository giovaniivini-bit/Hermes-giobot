...
| **Text layout demos** | Text corpus, font | Text-around-obstacle flow, kinetic type, word-brick games, ASCII mask layouts | `references/text-layout-pretext.md` |
...
| `references/text-layout-pretext.md` | Text-as-geometry demos via @chenglou/pretext — reflow around obstacles, word-brick games, ASCII mask obstacles, kinetic typography, multi-column layout |
